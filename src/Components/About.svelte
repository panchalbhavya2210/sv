		...
		<div class="sub-grid grid columns-2 lg:columns-1">
			...
			>
				<p>
					...
					Solutions. I graduated with a Bachelor of Computer Applications (BCA) in 2024 from Monark
					University. My deep passion for web development drives me to continuously explore and
					create innovative solutions that provide unique and seamless experiences for users.
				</p>
				<br />
				<p>
					With a strong foundation in computer science and a love for design, I specialize in
					crafting dynamic, user-friendly websites and applications. My goal is to stay ahead of
					industry trends and push the boundaries of what can be achieved in the digital world.
				</p>
			</div>
		</div>
	</section>
